...
from wrapper import face_align_func
import traceback
import numpy as np
...
def align_image(event, context):
    try:
        ...
        print("Start Aligning the Image")
        image = Image.open(io.BytesIO(image_bytes))
        print("Image Shape:", image.size)
        print("Image Shape:", image.size)
        np_image = np.array(image)
        al_image = face_align_func(np_image)
        pil_image = Image.fromarray(al_image)
        ...
        response = {'Status': 'Success', 'message': message, 'ImageBytes': res_image}
